...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<CreateAvailabilitySlotsUseCase>();
        services.AddScoped<GetMyAvailabilitySlotsUseCase>();
        services.AddScoped<DeleteAvailabilitySlotUseCase>();
        services.AddScoped<CreateAppointmentUseCase>();
        services.AddScoped<GetMyAppointmentsUseCase>();
        services.AddScoped<CancelAppointmentUseCase>();
        services.AddScoped<GetAvailableSlotsUseCase>();
        services.AddScoped<CreateClinicalNoteUseCase>();
        services.AddScoped<UpdateClinicalNoteUseCase>();
        services.AddScoped<GetClinicalNotesByPatientUseCase>();
        services.AddScoped<GetClinicalNoteByIdUseCase>();
